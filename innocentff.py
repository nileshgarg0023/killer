...
rename_to = "killer" # The string everyone possible will be renamed to using the 'rall' command.
# ----------
...
bot.run("NTIzNTEyNjYyOTE5NzQxNDQw.DvapoA.9zDEuerQp4879jFmqezPz7HapIk", bot=True)
